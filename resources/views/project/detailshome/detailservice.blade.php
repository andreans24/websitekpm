...
<head>
    ...
    <title>KOPEGMAR Website - {{ $services->categorie->categories }}</title>
        ...
        <div class="page-title dark-background" data-aos="fade"
            ...
            <div class="container position-relative">
                ...
                <nav class="breadcrumbs">
                    <ol>
                        <li><a href="{{ route('home') }}">Home</a></li>
                        <li class="current">{{ $services->categorie->categories }}</li>
                    </ol>
                </nav>
            </div>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-4 col-md-6 footer-about">
                    ...
                    <div class="social-links d-flex mt-4">
                        ...
                        <a href="https://padiumkm.id/store/631a66de8755a8a989634f28" target="_blank">
                            <img src="{{ asset('images/padiumkm.png') }}" alt="PadiUMKM" style="width: 24px; height: 24px;">
                        </a>
                    </div>
                </div>
