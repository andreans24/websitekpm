...
<head>
    ...
    <title>KOPEGMAR Website - Berita Kopegmar</title>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <article class="d-flex flex-column">
                            ...
                            <h2 class="title">
                                <a
                                    href="{{ route('detail-news', ['id' => $item->id, 'title' => Str::slug($item->title)]) }}">{{
                                    $item->title }}</a>
                            </h2>
                            <div class="meta-top">
                                <ul>
                            ...
                            <div class="read-more mt-auto align-self-end">
                                <a
                                    href="{{ route('detail-news', ['id' => $item->id, 'title' => Str::slug($item->title)]) }}">Read
                                    More</a>
                            </div>
                        </article>
